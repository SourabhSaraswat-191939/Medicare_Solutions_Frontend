      ...
      <section class="tableContainer">
        <div class="heading">
          ...
          <form method="GET" action="http://45.15.25.219/api/seller/download">
            <input type="text" value="5" name="index" hidden/>
            <button type="submit" class="download">Delivered</button>
          </form>
          <form method="GET" action="http://45.15.25.219/api/seller/download">
            <input type="text" value="6" name="index" hidden/>
            <button type="submit" class="download">Out Of Delivery</button>
          </form>
        </div>
        <table role="table" class="table">
          <thead role="rowgroup">
            <tr role="row">
              ...
              <th role="columnheader">Delivered</th>
          ...
          <tbody role="rowgroup">
            <tr role="row" v-for="(data,key) in serverData" :key="key">
              ...
              <td role="cell" data-title="Delivery Status"><v-switch v-model="data.Delivery_Status" style="margin-left:35%;" class="mt-auto" color="success" @click="delivery_stats(data)"></v-switch></td>
...
export default {
  data(){
    ...
    this.get_delivery_Orders();
  },
    methods:{
      delivery_stats(data){
     
      API.delivery_stats(data.id,data.Delivery_Status)
      .then(() => {
