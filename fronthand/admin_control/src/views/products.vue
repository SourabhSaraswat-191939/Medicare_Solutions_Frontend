      ...
      <section class="tableContainer">
        <div class="heading">
          ...
          <form method="GET" action="http://45.15.25.219/api/seller/download">
            <input type="text" value="2" name="index" hidden/>
            <button class="download" type="submit">Products</button>
          </form>
          ...
          <tbody role="rowgroup">
            ...
            <tr role="row" v-for="(data,key) in ProductData" :key="key">
              ...
              <td role="cell" data-title="image">
                ...
                <a :href="'http://45.15.25.219/api/seller'+data.Image" target="_blank"><img :src="'http://45.15.25.219/api/seller'+data.Image"></a>
              ...
              <td role="cell" data-title="Delete">
                <v-btn
                  elevated
                  color="error"
                   @click="DeleteProducts(data,key)" 
                ><v-icon dark>mdi-delete</v-icon>
                </v-btn>
                
              </td>

              <td role="cell" data-title="Status"><v-switch v-model="data.Availability" style="margin-left:35%;" class="mt-auto" color="success" @click="availability(data)"></v-switch></td>
            </tr>
          </tbody>
        </table>
...
//   FOR MEDICAL COMMENTING
  ...
  methods:{
    ...
    availability(data){
      ...
      API.availability(data.id,data.Availability)
      .then(() => {
    ...
    EditProducts(){
      let formData2 = new FormData();
        ...
        formData2.append('token',localStorage.getItem("ck"))
    ...
    closeEditForm() {
      ...
      async AddProduct() {
        ...
        // for (const i of Object.keys(this.product_image)) {
        //     formData.append('Image',this.product_image[i])
        //   }
      axios.post(process.env.VUE_APP_SERVER+'/seller/products',formData)
      .then(() => {
