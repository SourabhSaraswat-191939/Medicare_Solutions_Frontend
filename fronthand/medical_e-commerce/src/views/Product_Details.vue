...
<!--ratings-->
      ...
      <div class="row mt-4">
        ...
        <p style="font-size: 20px"> &nbsp; Delivery Now Available For Uttarakhand 
          <!-- | &nbsp; <span class="text-success">FREE</span>  -->
          </p>
      </div>
      <div class="row mt-4">
             <h4>Quantity: &nbsp; &nbsp;</h4>
      <div class="wrap quantity ml-0">
      ...
      <div class="card-text">
        <!-- <a class="btn btn-success text-light"> Buy Now</a> -->
         &nbsp; <a @click="AddToCart" class="btn btn-danger text-light"><i class="fa fa-cart-plus" aria-hidden="true"></i>  Add To Cart</a> <br/><br/>
      </div>
   ...
   props: ['exampleProp'],
    ...
    filters:
    {
      ImageUrl(value)
      {
        ...
        // console.log(value);
        return "http://45.15.25.219/api/seller/"+value.split("http://45.15.25.219/api/")[1];
      }
    }
}
</script>
