...
<div class="sign_up_page">
 ...
 <!-- <form  id="myform"> -->
    ...
    <input type="number" id="pincode" placeholder="Pin Code" required v-model="user.pin_code"><br><br>
 ...
 <!-- </form> -->
 <div class="already">
    Already have account?<router-link to="/login" style="text-decoration: none; font-family: 'Play', sans-serif; color: #00bfff;">&nbsp;Log In</router-link>
 </div>
</div>
</div>
...
export default {
    ...
    methods:{
        ...
        {
            var prereg = /[\\.]+[\\.]+([\\.]*)|(^[!# $ % & * + - = ? ^ _ { | } ~ \\ '])|[\s]/
            if(prereg.test(this.user.email))
                {
        ...
        sign_up(){
            ...
            .then(()=>{
                this.error_message="SUBMITTED. To Confirm your account please verify it from your Inbox or Spam Box. ";

                // console.log('Successfull')
            })
            .catch(()=>{
                console.log('Failed')
                this.error_message="Failed to Sign Up. May be due to Server or your Internet Connectivity or May be you had already Signed Up.";
